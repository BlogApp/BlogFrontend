...
import thoughts from "../../../assets/landing-page/thoughts.png"; 
  ...
  return (
    ...
    <section className="py-24 px-6 md:px-20 bg-white">
      ...
      <div className="max-w-4xl mx-auto text-center">
       <img src={thoughts} alt="thought bubble" className='w-15 h-15 text-black absolute left-230 -translate-y-15 '/>
